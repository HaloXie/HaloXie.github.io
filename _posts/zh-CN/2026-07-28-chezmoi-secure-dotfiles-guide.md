...
[![明文进入 Git 前的五层防线](/assets/img/chezmoi-secure-dotfiles/security-layers.webp)](/assets/img/chezmoi-secure-dotfiles/security-layers.webp)
...
[![配置同步的三条车道](/assets/img/chezmoi-secure-dotfiles/classification.webp)](/assets/img/chezmoi-secure-dotfiles/classification.webp)
...
[![分四批迁移开发环境](/assets/img/chezmoi-secure-dotfiles/migration-roadmap.webp)](/assets/img/chezmoi-secure-dotfiles/migration-roadmap.webp)
...
[![新设备安全恢复流程](/assets/img/chezmoi-secure-dotfiles/recovery.webp)](/assets/img/chezmoi-secure-dotfiles/recovery.webp)
...
[![秘密误提交后的正确处理顺序](/assets/img/chezmoi-secure-dotfiles/incident-response.webp)](/assets/img/chezmoi-secure-dotfiles/incident-response.webp)
